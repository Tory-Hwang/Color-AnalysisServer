...
static int Sobel5( pDIP_DATA ptrDIPData );
...
static int Roberts( pDIP_DATA ptrDIPData )
{
	...
	for( i = 1 ; i < ptrImageDataSrc->nH -1; i++ )
	{
		...
		{
			nW = -m_TmpImageData.ptrSrcImage2D[i-1][j+1] + m_TmpImageData.ptrSrcImage2D[i ][ j];
			nH = -m_TmpImageData.ptrSrcImage2D[i-1][j-1] +m_TmpImageData.ptrSrcImage2D[i][ j ];			
			
			if ( LineEdgeType == HW_LINE_EDGE )
			{
				dRobert = sqrt( (double)( nH*nH + nW*nW ));
				ptrImageDataSrc->ptrSrcImage2D[i][j] = (BYTE)LIMIT_VAL( dRobert );
			}
			else if ( LineEdgeType == W_LINE_EDGE )
			{
				ptrImageDataSrc->ptrSrcImage2D[i][j] = (BYTE)LIMIT_VAL( nW );
			}
			else 
			{
				ptrImageDataSrc->ptrSrcImage2D[i][j] = (BYTE)LIMIT_VAL( nH );
			}
		}
	}
...
static int Prewitt( pDIP_DATA ptrDIPData )
{
	...
	for( i = 0 ; i < ptrImageDataSrc->nH; i++ )
	{
		for( j = 0 ; j < ptrImageDataSrc->nW;j++)
		{
			...
			{
				nW = m_TmpImageData.ptrSrcImage2D[i-1][j-1] + m_TmpImageData.ptrSrcImage2D[i-1][j] + m_TmpImageData.ptrSrcImage2D[i-1][j+1]
				   - m_TmpImageData.ptrSrcImage2D[i+1][j-1] - m_TmpImageData.ptrSrcImage2D[i+1][j] - m_TmpImageData.ptrSrcImage2D[i+1][j+1];

				nH = - m_TmpImageData.ptrSrcImage2D[i-1][j-1] + m_TmpImageData.ptrSrcImage2D[i -1 ][j+1]
					 - m_TmpImageData.ptrSrcImage2D[i ][j-1] + m_TmpImageData.ptrSrcImage2D[i ][j+1]
					 - m_TmpImageData.ptrSrcImage2D[i+1][j-1] + m_TmpImageData.ptrSrcImage2D[i+1][j+1];				

				if ( LineEdgeType == HW_LINE_EDGE )
				{
					dPrewitt = sqrt( (double)( nH*nH + nW*nW ));
...
static int Sobel5( pDIP_DATA ptrDIPData )
{
	...
	for( i = 0 ; i < ptrImageDataSrc->nH; i++ )
	{
		for( j = 0 ; j < ptrImageDataSrc->nW;j++)
		{
			...
			if ( i == 0 || i == 1 || i == ptrImageDataSrc->nH -1 || i == ptrImageDataSrc->nH -2 ||
				 j == 0 || j == 1 || j == ptrImageDataSrc->nW - 1 || j == ptrImageDataSrc->nW - 2 )
			{
				ptrImageDataSrc->ptrSrcImage2D[i][j] = 0;
			}
			else
			{
#if 1
				nW = m_TmpImageData.ptrSrcImage2D[i-2][j-2] + m_TmpImageData.ptrSrcImage2D[i-2][j -1 ] + 2*m_TmpImageData.ptrSrcImage2D[i-2][j] + m_TmpImageData.ptrSrcImage2D[i-2][j +1 ] + m_TmpImageData.ptrSrcImage2D[i-2][j + 2 ]
				   + m_TmpImageData.ptrSrcImage2D[i-1][j-2] + m_TmpImageData.ptrSrcImage2D[i-1][j -1 ] + 2*m_TmpImageData.ptrSrcImage2D[i-1][j] + m_TmpImageData.ptrSrcImage2D[i-1][j +1 ] + m_TmpImageData.ptrSrcImage2D[i-1][j + 2 ]
				   - m_TmpImageData.ptrSrcImage2D[i+1][j-2] - m_TmpImageData.ptrSrcImage2D[i+1][j -1 ] - 2*m_TmpImageData.ptrSrcImage2D[i+1][j] - m_TmpImageData.ptrSrcImage2D[i+1][j +1 ] - m_TmpImageData.ptrSrcImage2D[i+1][j + 2 ]
				   - m_TmpImageData.ptrSrcImage2D[i+2][j-2] - m_TmpImageData.ptrSrcImage2D[i+2][j -1 ] - 2*m_TmpImageData.ptrSrcImage2D[i+2][j] - m_TmpImageData.ptrSrcImage2D[i+2][j +1 ] - m_TmpImageData.ptrSrcImage2D[i+2][j + 2 ] ;
#else

				   nW = -m_TmpImageData.ptrSrcImage2D[i-2][j-2] -4*m_TmpImageData.ptrSrcImage2D[i-2][j -1 ] - 6*m_TmpImageData.ptrSrcImage2D[i-2][j] -4* m_TmpImageData.ptrSrcImage2D[i-2][j +1 ] -m_TmpImageData.ptrSrcImage2D[i-2][j + 2 ]
				   -2*m_TmpImageData.ptrSrcImage2D[i-1][j-2] -8*m_TmpImageData.ptrSrcImage2D[i-1][j -1 ] -12*m_TmpImageData.ptrSrcImage2D[i-1][j] -8*m_TmpImageData.ptrSrcImage2D[i-1][j +1 ] -2*m_TmpImageData.ptrSrcImage2D[i-1][j + 2 ]
				   +2*m_TmpImageData.ptrSrcImage2D[i+1][j-2] +8*m_TmpImageData.ptrSrcImage2D[i+1][j -1 ] +12*m_TmpImageData.ptrSrcImage2D[i+1][j] +8*m_TmpImageData.ptrSrcImage2D[i+1][j +1 ] +2*m_TmpImageData.ptrSrcImage2D[i+1][j + 2 ]
				   +m_TmpImageData.ptrSrcImage2D[i+2][j-2] +4*m_TmpImageData.ptrSrcImage2D[i+2][j -1 ] +6*m_TmpImageData.ptrSrcImage2D[i+2][j] +4*m_TmpImageData.ptrSrcImage2D[i+2][j +1 ] + m_TmpImageData.ptrSrcImage2D[i+2][j + 2 ] ;
#endif

#if 1
			   nH = - m_TmpImageData.ptrSrcImage2D[i-2][j-2] - m_TmpImageData.ptrSrcImage2D[i-2][j -1 ] + m_TmpImageData.ptrSrcImage2D[i-2][j +1 ] + m_TmpImageData.ptrSrcImage2D[i-2][j + 2 ]
			        - m_TmpImageData.ptrSrcImage2D[i-1][j-2] - m_TmpImageData.ptrSrcImage2D[i-1][j -1 ] + m_TmpImageData.ptrSrcImage2D[i-1][j +1 ] + m_TmpImageData.ptrSrcImage2D[i-1][j + 2 ]
					- 2*m_TmpImageData.ptrSrcImage2D[ i ][j-2] - 2*m_TmpImageData.ptrSrcImage2D[ i ][j -1 ] + 2*m_TmpImageData.ptrSrcImage2D[ i ][j +1 ] + 2*m_TmpImageData.ptrSrcImage2D[ i ][j + 2 ]
			        - m_TmpImageData.ptrSrcImage2D[i+1][j-2] - m_TmpImageData.ptrSrcImage2D[i+1][j -1 ] + m_TmpImageData.ptrSrcImage2D[i+1][j +1 ] + m_TmpImageData.ptrSrcImage2D[i+1][j + 2 ]
			        - m_TmpImageData.ptrSrcImage2D[i+2][j-2] - m_TmpImageData.ptrSrcImage2D[i+2][j -1 ] + m_TmpImageData.ptrSrcImage2D[i+2][j +1 ] + m_TmpImageData.ptrSrcImage2D[i+2][j + 2 ] ;
#else
					nH = m_TmpImageData.ptrSrcImage2D[i-2][j-2] +2*m_TmpImageData.ptrSrcImage2D[i-2][j -1 ] -2* m_TmpImageData.ptrSrcImage2D[i-2][j +1 ] - m_TmpImageData.ptrSrcImage2D[i-2][j + 2 ]
					+4*m_TmpImageData.ptrSrcImage2D[i-1][j-2] +8* m_TmpImageData.ptrSrcImage2D[i-1][j -1 ] -8* m_TmpImageData.ptrSrcImage2D[i-1][j +1 ] -4* m_TmpImageData.ptrSrcImage2D[i-1][j + 2 ]
					+6*m_TmpImageData.ptrSrcImage2D[ i ][j-2] +12*m_TmpImageData.ptrSrcImage2D[ i ][j -1 ] - 12*m_TmpImageData.ptrSrcImage2D[ i ][j +1 ] - 6*m_TmpImageData.ptrSrcImage2D[ i ][j + 2 ]
					+4*m_TmpImageData.ptrSrcImage2D[i+1][j-2] +8*m_TmpImageData.ptrSrcImage2D[i+1][j -1 ] -8* m_TmpImageData.ptrSrcImage2D[i+1][j +1 ] -4* m_TmpImageData.ptrSrcImage2D[i+1][j + 2 ]
					+m_TmpImageData.ptrSrcImage2D[i+2][j-2] +2*m_TmpImageData.ptrSrcImage2D[i+2][j -1 ] -2* m_TmpImageData.ptrSrcImage2D[i+2][j +1 ] - m_TmpImageData.ptrSrcImage2D[i+2][j + 2 ] ;
#endif
				if ( LineEdgeType == HW_LINE_EDGE )
				{
					dSobel = sqrt( (double)( nH*nH + nW*nW ));
...
/*========================================================================================
	Sobel 3*3Mask( 경계선 추출 )
	
	Horizon(nW)            Vertical( nH )
	 1  2  1			   -1  0  1
	 0  0  0               -2  0  2
	-1 -2 -1               -1  0  1
=========================================================================================*/
static int Sobel( pDIP_DATA ptrDIPData )
{
	...
	for( i = 0 ; i < ptrImageDataSrc->nH; i++ )
	{
		for( j = 0 ; j < ptrImageDataSrc->nW;j++)
		{
			...
			{
				nW = m_TmpImageData.ptrSrcImage2D[i-1][j-1] + 2*m_TmpImageData.ptrSrcImage2D[i-1][j] + m_TmpImageData.ptrSrcImage2D[i-1][j+1]
				   - m_TmpImageData.ptrSrcImage2D[i+1][j-1] - 2*m_TmpImageData.ptrSrcImage2D[i+1][j] - m_TmpImageData.ptrSrcImage2D[i+1][j+1];

				nH = - m_TmpImageData.ptrSrcImage2D[i-1][j-1] + m_TmpImageData.ptrSrcImage2D[i-1][j+1]
				     - 2*m_TmpImageData.ptrSrcImage2D[i ][j-1] + 2*m_TmpImageData.ptrSrcImage2D[ i ][j+1]
					 - m_TmpImageData.ptrSrcImage2D[i+1][j-1] + m_TmpImageData.ptrSrcImage2D[ i+1 ][j+1];
