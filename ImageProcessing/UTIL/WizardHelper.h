...
public:
	...
	void DrawRectLine( HDC hdc, int nImageH, CVRECT_t * ptrRect, int bDraw, int nExtX=0, int nExtY = 0);
	void DrawCharRectLine( HDC hdc, int nImageH, int nCharCnt, CVRECT_t * ptrPlateRect , LPR_CHAR_t * ptrLPRChar ,int bDraw,  int nExtX=0, int nExtY = 0);
