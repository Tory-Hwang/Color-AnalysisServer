...
/*=========================================================================
 OTSU 이진화 처리 
==========================================================================*/
 int Binarization_Otsu( pDIP_DATA ptrDIPData, pIMAGE_DATA ptrImageData, BINARIZATION_PARAM_t * ptrOtsu_Param )
 {	 
	 BINARIZATION_PARAM_t Binary_Param, *ptrParam;

	 if ( ptrOtsu_Param != NULL )
	 {
		 ptrParam = ptrOtsu_Param;
	 }
	 else
	 {
		memset(&Binary_Param, 0, sizeof( BINARIZATION_PARAM_t ));
		ptrParam =&Binary_Param;
	 }
 ...
 int Prewitt( pDIP_DATA ptrDIPData, pIMAGE_DATA ptrImageData , BYTE LineEdgeType)
{
 ...
 /*=========================================================================
  SOBEL5 경계선 검출
==========================================================================*/
 int Sobel5( pDIP_DATA ptrDIPData, pIMAGE_DATA ptrImageData , BYTE LineEdgeType)
{
	LINE_EDGE_PARAM_t LineEdgeParam;
	...
	ptrDIPData->ptrImageDataSrc1 = ptrImageData;
	ptrDIPData->uDIPMsg = TK_DIP_SOBEL5_MSG;
	ptrDIPData->ptrInputParam = &LineEdgeParam;
...
==========================================================================*/
 ...
 /*=========================================================================  
   그레이스케일
==========================================================================*/
 int GrayScale( pDIP_DATA ptrDIPData, pIMAGE_DATA ptrImageSrcData, pIMAGE_DATA ptrImageDestData)
 {
	ptrDIPData->ptrImageDataSrc1 = ptrImageSrcData;
	ptrDIPData->ptrImageDataDest = ptrImageDestData;
	ptrDIPData->uDIPMsg = TK_DIP_CONVERTGRAY_MSG;	
